...
document.onclick = function() {
    ...
    setTimeout(function() {
        if (document.readyState === 'complete') {
            ...
            if (document.getElementsByClassName("xo-icon-add fa-1x fa-fw")[0]) {
                if (document.getElementsByClassName("xo-icon-add fa-1x fa-fw")[0].parentElement.childNodes[4]) {
